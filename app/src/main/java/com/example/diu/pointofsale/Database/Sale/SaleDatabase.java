package com.example.diu.pointofsale.Database.Sale;

import android.content.ContentValues;

import com.example.diu.pointofsale.Database.DatabaseContents;
import com.example.diu.pointofsale.Database.IDatabase;
...
import com.example.diu.pointofsale.Model.Sale.QuickLoadSale;
import com.example.diu.pointofsale.Model.Sale.Sale;

import java.util.ArrayList;
import java.util.Calendar;
import java.util.List;

public class SaleDatabase implements ISaleDatabase{
    IDatabase database;
    public SaleDatabase(IDatabase database) {
