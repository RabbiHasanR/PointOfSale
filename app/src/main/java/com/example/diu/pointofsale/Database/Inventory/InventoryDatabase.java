package com.example.diu.pointofsale.Database.Inventory;
...
import com.example.diu.pointofsale.Model.Inventory.ProductLot;
...
public class InventoryDatabase implements IInventoryDatabase{
     ...
     */
    public InventoryDatabase(IDatabase database) {
